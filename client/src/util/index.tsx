...
const BACKEND_URL = (typeof __API_SERVER_URL__ === 'undefined' ? 'http://localhost:18080' : __API_SERVER_URL__);

export const url = (path: string): string => `http://localhost:18080/${path}`;
